    ...
    <div class="
        ...
        <aside class="h-full space-y-4 text-base font-normal">
            ...
            <div class="flex flex-col divide-y divide-gray-600">
                <div>
                    <!-- Button -->
                    <a href="{{ route('plan_de_negocio.estudio.show', [$plan_de_negocio, $estudio]) }}" class="flex w-full items-center gap-2 p-4 my-1 rounded-md hover:bg-gray-200 hover:dark:bg-gray-700">
                ...
                <div class="relative">
                    <!-- Button -->
                    <a href="{{ route('plan_de_negocio.estudio.concepto.index', [$plan_de_negocio, $estudio]) }}" class="flex w-full items-center gap-2 p-4 my-1 rounded-md hover:bg-gray-200 hover:dark:bg-gray-700">
                ...
                <div class="relative">
                    <!-- Button -->
                    <a href="{{ route('plan_de_negocio.estudio.capturar_resultado.index', [$plan_de_negocio, $estudio]) }}" class="flex w-full items-center gap-2 p-4 my-1 rounded-md hover:bg-gray-200 hover:dark:bg-gray-700">
                ...
                <div class="relative">
                    <!-- Button -->
                    <a href="{{ route('plan_de_negocio.estudio.conclusion.index', [$plan_de_negocio, $estudio]) }}" class="flex w-full items-center gap-2 p-4 my-1 rounded-md hover:bg-gray-200 hover:dark:bg-gray-700">
                ...
                <div class="relative">
                    <!-- Button -->
                    <a href="{{ route('plan_de_negocio.estudio.index', [$plan_de_negocio]) }}" class="flex w-full items-center gap-2 p-4 my-1 rounded-md hover:bg-gray-200 hover:dark:bg-sky-900 dark:bg-sky-800">
