            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="col-span-1">
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white shadow-lg rounded-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                            <thead>
                                <tr class="bg-gray-100 border-b dark:bg-gray-700 dark:border-gray-600">
                                    <th class="px-4 py-2 text-left text-gray-700 font-medium dark:text-gray-300">Descripción</th>
                            ...
                            <tbody>
                                <tr class="border-b hover:bg-gray-50 transition dark:hover:bg-gray-600">
                                    ...
                                    <td class="border px-4 py-2 text-right dark:border-gray-700">${{ number_format($total, 2) }}</td>
                                </tr>
                                <tr class="border-b hover:bg-gray-50 transition dark:hover:bg-gray-600">
                                    <td class="border px-4 py-2 dark:border-gray-700">Total de Sueldos Anuales</td>
                                    <td class="border px-4 py-2 text-right dark:border-gray-700">${{ number_format($total * 12, 2) }}</td>
                                </tr>
                                <tr class="border-b hover:bg-gray-50 transition dark:hover:bg-gray-600">
                                    <td class="border px-4 py-2 dark:border-gray-700">Total de Sueldos en 5 Años</td>
                                    <td class="border px-4 py-2 text-right dark:border-gray-700">${{ number_format(($total * 12) * 5, 2) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="col-span-1 flex justify-center items-center">
                    <a class="bg-green-500 text-white px-8 py-12 rounded-lg hover:bg-green-600 transition border border-green-500 hover:border-green-600 w-full text-center text-xl dark:bg-green-700 dark:border-green-600 dark:hover:bg-green-800">
                        Proyección 5 Años
                    </a>
                </div>
