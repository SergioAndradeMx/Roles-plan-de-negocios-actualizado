<div class="bg-gray-700 text-white  shadow-sm rounded-lg p-4">
    <ul class="space-y-4">
        <!-- Primer enlace -->
        <li>
            <a href="{{ route('plan_de_negocio.descripciones.index', $plan_de_negocio) }}"
                class="flex items-center text-white  hover:text-lime-700 dark:hover:text-lime-500 transition-all duration-200">
