                        ...
                        <div class="mr-2">
                            <div class="relative inline-flex self-center">
                                ...
                                <select name="tipo" class="text-base font-bold rounded border-2 border-gray-700 text-gray-600 h-auto w-auto py-3 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
                                    <option value="nombre_grupo">Por nombre del grupo</option>
                    ...
                    @else
                        @foreach ($grupos as $grupo)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    {{ count(json_decode($grupo->integrantes)) }}
                                </td>
                                <td class="px-6 py-4">
                                    <div class="inline-flex">
                                        <a href="{{ route('grupo_show_admin', [$grupo]) }}" class="inline-flex items-center px-1.5 py-1.5 bg-gray-500 hover:bg-gray-400 dark:bg-gray-700 dark:hover:bg-gray-600 text-white text-sm font-medium rounded-md">
                                        ...
                                        <form method="post" action="{{ route('grupo_complete_destroy', [$grupo]) }}">
                                            @method('delete')
                                            @csrf
                                            <button type="submit"
