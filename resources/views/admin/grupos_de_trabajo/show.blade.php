<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between dark:text-gray-100">
            ...
            <a class="flex flex-nowrap md:rounded-md bg-slate-700 text-white dark:md:bg-gray-700 md:p-2" href="{{ route('grupo_admin.edit', [$grupo])}}">          
    ...
    <div class="mx-auto justify-center px-auto dark:text-gray-100 px-20 py-6">
        <div class="w-full flex justify-center mb-4">
            <a class="flex flex-nowrap md:rounded-md bg-blue-500 text-white font-bold dark:text-gray-300 dark:md:bg-gray-700 md:p-2" href="{{ route('grupo_busqueda_admin.index', [$grupo])}}">
                <span class="visible md:hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                    </svg>
                </span>            
                <p class="hidden md:flex text-md">Añadir integrante</p>
            </a>
        </div>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <div class="inline-flex">
                                        <a href="{{ route('planes_admin.index', [$integrante]) }}" class="inline-flex items-center px-1.5 py-1.5 bg-blue-500 hover:bg-blue-400 dark:bg-blue-700 dark:hover:bg-blue-600 text-white text-sm font-medium rounded-md">
