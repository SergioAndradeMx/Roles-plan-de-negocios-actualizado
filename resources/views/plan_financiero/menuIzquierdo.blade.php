<ol class="relative  border-s border-gray-200 dark:border-gray-700  ">
    ...
    <a href="{{ route('plan_de_negocio.costo_variable.index', $plan_de_negocio) }}">
        <div class="mb-10 ">
            <li class="mb-10 ms-6">
                ...
                <h3 class="text-gray-400 leading-tight pt-1.5">Costos Variables</h3>
            </li>
        </div>
    </a>
    ...
    <a href="{{route('plan_de_negocio.estadisticas.index', $plan_de_negocio)}}">
        <li class="ms-6">
            ...
            <h3 class="text-gray-400 leading-tight lg:text-sm lg:pt-1 2xl:pt-1.5">Proyeccion de un año</h3>
        </li>
    </a>
</ol>
