...
<head>
    ...
    <title>Costo variable</title>
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/menuIzquierdo', 'resources/js/costoVariable'])
</head>
...
<body>
    ...
    <div class="flex justify-center items-start 2xl:px-10 flex-wrap gap-10 w-full h-full ">
        ...
        <div class="card w-3/4 mt-3">
            <h2 class="text-center text-2xl dark:text-white my-5">Progreso de costo variable</h2>
            <hr class="my-2 h-0.5 border-t-0 w-full bg-neutral-100 dark:bg-white m-0 p-0" />
            <div class="px-2 pb-2 mx-2 mb-2 bg-white">
                <h2 class="text-center py-4  2xl:text-2xl text-lg font-normal">Ingrese el costo variable</h2>
                    ...
                    <tbody>
                        @foreach ($costos_variable as $costos_variable)
                            <tr>
                                ...
                                <td class="border px-4 py-2"><input type="text"
                                        class="w-full border rounded-sm px-2 py-1 text-right"
                                        value="{{ $costos_variable->escenario_conservador }}" disabled>
                                </td>
                                <td class="border px-4 py-2"><input type="text"
                                        class="w-full border rounded-sm px-2 py-1 text-right"
