<x-app-layout class="flex flex-nowrap">
    ...
    <div class="w-full">
        ...
        <div class="mx-20 flex items-center justify-center my-6">
            <form class="w-full" method="POST" enctype="multipart/form-data" action="{{ route('grupo_detalles', [$grupo]) }}">
                @csrf
                @method('PATCH')
                <div class="dark:bg-gray-800 shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                    ...
                    <div class="flex justify-center items-center">
                        <div class="">
                            <a href="{{ route('grupo.show', [$grupo]) }}" class="m-4 bg-red-900 text-white font-bold py-4 px-10 border-gray-500 dark:hover:bg-red-800 rounded-xl">
                                Cancelar
                            </a>
